...
var GiftedListView = React.createClass({
  ...
  propTypes: {
    customStyles: ViewPropTypes.object,
    initialListSize: ViewPropTypes.number,
    onEndReachedThreshold: ViewPropTypes.number,
    onEndReachedEventThrottle: ViewPropTypes.number,
    firstLoader: ViewPropTypes.bool,
    pagination: ViewPropTypes.bool,
    refreshable: ViewPropTypes.bool,
    refreshableColors: ViewPropTypes.array,
    refreshableProgressBackgroundColor: ViewPropTypes.string,
    refreshableSize: ViewPropTypes.string,
    refreshableTitle: ViewPropTypes.string,
    refreshableTintColor: ViewPropTypes.string,
    renderRefreshControl: ViewPropTypes.func,
    headerView: ViewPropTypes.func,
    sectionHeaderView: ViewPropTypes.func,
    scrollEnabled: ViewPropTypes.bool,
    withSections: ViewPropTypes.bool,
    autoPaginate: ViewPropTypes.bool,
    lazyLoade: ViewPropTypes.bool,
    onFetch: ViewPropTypes.func,

    paginationFetchingView: ViewPropTypes.func,
    paginationAllLoadedView: ViewPropTypes.func,
    paginationWaitingView: ViewPropTypes.func,
    emptyView: ViewPropTypes.func,
    renderSeparator: ViewPropTypes.func,

    rowHasChanged: ViewPropTypes.func,
    distinctRows: ViewPropTypes.func,
    rows: ViewPropTypes.array,
    fetchOptions: ViewPropTypes.object,
  },
