    ...
    return (
      <View style={styles.content}>
        <SearchBar
          ...
          onChangeText={(v)=>{console.log(v,1)}}
          onClearText={(v)=>{console.log(v,2)}}
          placeholder='搜索' 
          containerStyle={{backgroundColor:commonStyle.white,borderTopWidth:0, borderBottomWidth:0}}
          inputStyle={{fontSize:14,backgroundColor:"#f1f1f1",borderRadius:10}}
          onFocus={()=>{
            Actions.search()
          }}
        />
